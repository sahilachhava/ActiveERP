...
$n = "";
$sql1 = "select * from ro_hoarding where r_no=".$_GET["nro"];
...
<head>
        ...
        <title>Edit Hoarding RO :: Active ERP</title>
                                    ...
                                    <div class="page-title-box">
                                        <div class="btn-group float-right">
                                            <ol class="breadcrumb hide-phone p-0 m-0">
                                                ...
                                                <li class="breadcrumb-item active">Update Hoarding RO</li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">Update Hoarding RO</h4>
                                    </div>
                                </div>
                            </div>
...
<?php
	if(isset($_POST['save']))
	{
		...
		$sql = "update ro_hoarding set emp_name='$em' where r_no=".$_GET['nro'];
		$result = mysqli_query($conn,$sql);
		
		$sql2 = "update purchase_hoarding set emp_name='$em' where ro_no=".$_GET['nro'];
		$result2 = mysqli_query($conn,$sql2);
		
		$sql3 = "update sales_hoarding set emp_name='$em' where ro_no=".$_GET['nro'];
		$result3 = mysqli_query($conn,$sql3);
		
		$sql1 = "update hcombo set emp_name='$em' where ro_no=".$_GET['nro'];
		$result1 = mysqli_query($conn,$sql1);
		...
		echo "<script type='text/javascript'>
			window.location.href = 'hoarding.php';
			</script>";
	}
?>