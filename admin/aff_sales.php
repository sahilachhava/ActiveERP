                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <select class="form-control" name="fno" required>
                                                        ...
                                                        <?php
							 include("../connection.php");
							 $sup1 = "select id,client from aff_booking where s=0"; 
...
<?php
	if(isset($_POST['save']))
	{
		...
		$sql9 = "insert into income(dt,pur,amt,des,emp,sale_id,type,in_no,ron) values('$dt','Tax Invoice No - T/0$inn','$pof','Client: $cc,  Booking Form No: AFF/0$fno','$mp','$son','aff','$in_no','$fno')";
