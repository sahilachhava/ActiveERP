...
if(isset($_GET['sid']))
{
	$sql1 = "select * from purchase_hoarding where id=".$_GET["sid"];
...
{
	$sql1 = "select * from purchase_hoarding where id = (select max(id) from purchase_hoarding)";
	$result1 = mysqli_query($conn,$sql1);
	while($row=mysqli_fetch_array($result1))
	{
		extract($row);
...
<body>
	<div id="page-wrap">
		...
		<a href="purchase_hoarding.php"><div id="back"></div></a>
