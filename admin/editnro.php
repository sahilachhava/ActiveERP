...
$n = "";
$sql1 = "select * from ro_newspaper where r_no=".$_GET["nro"];
...
<head>
        ...
        <title>Edit Newspaper RO :: Active ERP</title>
                                    ...
                                    <div class="page-title-box">
                                        <div class="btn-group float-right">
                                            <ol class="breadcrumb hide-phone p-0 m-0">
                                                ...
                                                <li class="breadcrumb-item active">Update Newspaper RO</li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">Update Newspaper RO</h4>
                                    </div>
                                </div>
                            </div>
...
<?php
	if(isset($_POST['save']))
	{
		...
		$sql = "update ro_newspaper set emp_name='$em' where r_no=".$_GET['nro'];
		$result = mysqli_query($conn,$sql);
		
		$sql2 = "update purchase_newspaper set emp_name='$em' where ro_no=".$_GET['nro'];
		$result2 = mysqli_query($conn,$sql2);
		
		$sql3 = "update sales_newspaper set emp_name='$em' where ro_no=".$_GET['nro'];
		$result3 = mysqli_query($conn,$sql3);
		
		$sql1 = "update ncombo set emp_name='$em' where ro_no=".$_GET['nro'];
		$result1 = mysqli_query($conn,$sql1);
