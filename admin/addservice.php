...
<head>
        ...
        <title>Add Service :: Active ERP</title>
			    ...
			    <div class="row">
					...
					<form action="<?php $_PHP_SELF ?>" method="post">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" name="name" placeholder="Service Name" value="" id="example-text-input" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-search-input" class="col-sm-2 col-form-label">Type of Service</label>
                                                <div class="col-sm-10">
...
<?php
	if(isset($_POST['name']))
	{
		...
		$sql = "insert into product(name,type,emp_name) values('$name','$type','$emp')";
