			...
			<div class="row">
                                <div class="col-12">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">Overall Profit :  <?php $sql2 = "select profit from combo";
												...
												function poss($num,$emp)
												{
													$num = number_format($num,2);
													echo "<b>$emp's Profit : $num</b>";
												}
												echo "Rs. $pro";
												?></h4>
					...
					<th>Payable GST</th>
						...
						if(isset($_REQUEST['emp']) or isset($_REQUEST['month']))
						{
							...
							$dd = $_REQUEST["month"];
							if($_REQUEST["emp"] != ""){
								$query = "SELECT * FROM `combo` WHERE `emp_name` like '$s%'";
							}
							if($_REQUEST["month"] != "0"){
								if($query == ""){
									$query = "SELECT * FROM `combo` WHERE `ro_dt` BETWEEN '2018/$dd/01' AND '2018/$dd/31'";
								}else{
