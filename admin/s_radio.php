...
<!-- Sweet Alert -->
	...
	$('document').ready(function () {
		...
		inputOptions: {
			<?php
				$sl = "select * from ro_radio where s=0";
...
<?php
	...
	if(isset($_POST['save']))
	{
		...
		$sql1 = "update ro_radio set s_total= '$amt', profit='$profit' where r_no=".$ron;
		$result1 = mysqli_query($conn,$sql1);
		$sql1 = "update purchase_radio set s_total= '$amt', profit='$profit', s=1 where ro_no=".$ron;
		$result1 = mysqli_query($conn,$sql1);
