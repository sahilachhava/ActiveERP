...
<?php
	if(isset($_POST['save']))
	{
		...
		$sql9 = "insert into income(dt,pur,amt,des,emp,sale_id,type,in_no,ron) values('$dt','Tax Invoice No - T/0$inn','$pof','Client: $cus,  Release Order No: $rono, Tender No: $ten, Tender Date: $tdt','$emp','$son','rail','$inn','$ron')";
