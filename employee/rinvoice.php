...
if(isset($_GET['sid']))
{
	$sql1 = "select * from ro_radio where id=".$_GET["sid"];
...
{
	$sql1 = "select * from ro_radio where id = (select max(id) from ro_radio)";
	$result1 = mysqli_query($conn,$sql1);
	while($row=mysqli_fetch_array($result1))
	{
		extract($row);
...
<body>
	<div id="page-wrap">
		...
		<a href="radio.php"><div id="back"></div></a>
	    ...
	    GLS University
            ...
            <table id="meta">
                <tr>
                    ...
                    <td  align="center"><?php 
			$ins = "select id from ro where type='radio' and type_id=".$in;
