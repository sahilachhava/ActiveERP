...
<head>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                     <select class="form-control" name="ro" required>
                                                        ...
                                                        <?php
							 include("../connection.php");
							 $sup1 = "select r_no,client from ro_newspaper where status=0 and emp_name=(select name from employee_details where id=".$_SESSION['user_id'].")";
	...
	allowOutsideClick: false
		...
		inputOptions: {
			<?php
				$sl = "select * from ro_newspaper where status=0 and emp_name=(select name from employee_details where id=".$_SESSION['user_id'].")";
