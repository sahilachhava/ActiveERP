...
<head>
        ...
        <title>Newspaper Combo Reports :: Active ERP</title>
                                    ...
                                    <div class="page-title-box">
                                        <div class="btn-group float-right">
                                            <ol class="breadcrumb hide-phone p-0 m-0">
                                                ...
                                                <li class="breadcrumb-item active">Newspaper Combo Reports</li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">Newspaper Combo Reports</h4>
                                    </div>
                                </div>
                            </div>
                            <!-- end page title end breadcrumb -->
			    <!-- dashboard content write below-->
			    <form action="ncreport.php" method="post">
			...
			<div class="row">
                                <div class="col-12">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">Overall Profit :  <?php $sql2 = "select profit from ncombo where emp_name=(select name from employee_details where id=".$_SESSION["user_id"].")";
					...
					<th>Sales</th>
						...
						if(isset($_REQUEST['month']))
						{
							...
							if($_REQUEST["month"] != ""){
								if($query == ""){
									$query = "SELECT * FROM `ncombo` WHERE `ro_dt` BETWEEN '2018/$dd/01' AND '2018/$dd/31' and emp_name=(select name from employee_details where id=".$_SESSION["user_id"].")";
								}
							}
							...
							while($row=mysqli_fetch_array($result))
							{
								...
								echo "<td> $pf </td>";
								echo "<td> $gs </td>";
								echo "<td><a href='newspaper_purchase.php?supu=".$sup_in."'><button class='btn btn-primary waves-effect waves-light dro'>View</button></a></td>";
								echo "<td><a href='newspaper_invoice.php?sid=".$sale_in."'><button class='btn btn-primary waves-effect waves-light dro'>View</button></a></td>";
								echo "</tr>";
							}
						}
						else
						{
							include("../connection.php");
							$sql = "select * from ncombo where emp_name=(select name from employee_details where id=".$_SESSION["user_id"].")";
