                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                     <select class="form-control" name="ro[]" required>
                                                        ...
                                                        <?php
							 include("../connection.php");
							 $sup1 = "select r_no,client from ro_newspaper where s=0 and emp_name=(select name from employee_details where id=".$_SESSION['user_id'].")";
...
<?php
	if(isset($_POST['save']))
	{
		...
		echo "<script type='text/javascript'>
			window.location.href = 's_newspaper_combo.php?$ttt';
			</script>";
	}
?>