			    ...
			    <div class="row">
					...
					<div class="form-group row">
					    ...
					    <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="number" value="" placeholder="Maximum GST Rate for set" name="grate" id="example-time-input" required>
                                                </div>
                                            </div>
					    <div class="amore">
...
<?php
	if(isset($_POST['save']))
	{
		...
		values('$dt','$hsn','$ten','$tdt','$client','$gsty','$rono','$pn','$des','$pl','$dc','$cc','$al','$desp','$dest','$quan','$rate','$grt','$dis','$mcrate','$manch','$amt','$sgst','$cgst','$tax','$gtotal','$emp')";
