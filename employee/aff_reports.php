...
<head>
    ...
    <?php include('header.php'); ?>
			    ...
			    <?php
				$coun = 0;
				$sql2 = "select * from aff_sales where emp_name=(select name from employee_details where id=".$_SESSION["user_id"].")";
			 ...
			 <div class="row">
                                <div class="col-12">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title"><?php echo "<font color='#00008b'>Your NET Income (Rs.): "."&nbsp; &nbsp;".number_format($coun,2)."</font>"; ?></h4> <br>
					...
					<tfoot align="center">
						...
						<?php 
							...
							echo "<td><b>Rs. ".number_format($ta,2)."</b></td>";
							?> 
						</tr>
					</tfoot>
                                            </table></div>
					...
					<tfoot align="center">
						...
						<?php 
							...
							echo "<td><b>Rs. ".number_format($tas,2)."</b></td>";
							?> 
						</tr>
					</tfoot>
                                            </table>
