...
if(isset($_GET['sid']))
{
	$sql1 = "select * from sales_led where id=".$_GET["sid"];
...
{
	$sql1 = "select * from sales_led where id = (select max(id) from sales_led)";
	$result1 = mysqli_query($conn,$sql1);
	while($row=mysqli_fetch_array($result1))
	{
		extract($row);
...
<body>
	<div id="page-wrap">
		...
		<a href="led.php"><div id="back"></div></a>
	    ...
	    GLS University
            ...
            <table id="meta">
                <tr>
                    ...
                    <td  align="center"><?php 
			$ins = "select id from invoice where type='led' and type_id=".$in;
