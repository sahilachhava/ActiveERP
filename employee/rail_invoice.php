...
if(isset($_GET['sid']))
{
	$sql1 = "select * from sales_rail where id=".$_GET["sid"];
...
{
	$sql1 = "select * from sales_rail where id = (select max(id) from sales_rail)";
	$result1 = mysqli_query($conn,$sql1);
	while($row=mysqli_fetch_array($result1))
	{
		extract($row);
...
<body>
	<div id="page-wrap">
		...
		<a href="rail_sales_details.php"><div id="back"></div></a>
	    ...
	    GLS University
            ...
            <table id="meta">
                <tr>
                    ...
                    <td  align="center"><?php echo "T/0$inv/2018-19"; ?></td>
                </tr>
                <tr>
