...
<?php
	if(isset($_POST['save']))
	{
		...
		$sql = "insert into ro_newspaper(sup,dt,bdt,news,hsn,client,edi,rdt,size,page,print,quan,rate,dis,amt,sgst,cgst,gtotal,emp_name) 
		values('$sup','$dt','$bdt','$news','$hs','$client','$edi','$rdt','$size','$page','$print','$quan','$rate','$dis','$amt','$sgst','$cgst','$gtotal','$emp')";
