...
<?php
	if(isset($_POST['save']))
	{
		...
		$sql9 = "insert into income(dt,pur,amt,des,emp,sale_id,type,in_no) values('$dt','Tax Invoice No - T/0$inn','$pof','Client: $cus,  Release Order No: R/0$ron','$emp','$son','radio','$inn')";
