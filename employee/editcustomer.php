...
$sql1 = "select * from customer_details where id=".$_GET["cid"];
...
<head>
        ...
        <title>Update Customer :: Active ERP</title>
			    ...
			    <div class="row">
					...
					<form action="<?php $_PHP_SELF ?>" method="post">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" name="name" placeholder="Company/Customer Name" value="<?php echo $n;?>" id="example-text-input" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
					...
					<div class="form-group">
					 <label for="example-time-input" class="col-sm-2 col-form-label" ></label>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <button type="submit" class="btn btn-primary waves-effect waves-light">Update Customer</button>
...
<?php
	...
	{
		include("../connection.php");
		$sql1 = "select name from employee_detail where id=".$_SESSION["user_id"];
		$result1 = mysqli_query($conn,$sql1);
		...
		$sql = "update customer_details set name='$name',street='$street',area='$area',city='$city',state='$state',pincode='$pin',email='$mail',phone='$phone',pan='$pan',gst='$gst' where id=".$_GET["cid"];
