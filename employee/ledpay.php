...
<head>
        ...
        <title>Our Debtors (LED) :: Active ERP</title>
   ...
   <?php include('header.php'); ?>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title">Our Debtors (LED)</h4>
                                    </div>
                                </div>
                            </div>
			    ...
			    <?php
				$sql2 = "select gtotal from sales_led where pay=0 and emp_name=(select name from employee_details where id=".$_SESSION['user_id'].")";
			...
			?>
			 <div class="row">
                                <div class="col-12">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title"><?php echo "Total Our Debtors (LED) :"." "."Rs. ".array_sum($total); ?></h4> <br>
						...
						<th>All Paid</th>
                                                ...
                                                <?php
                                                include("../connection.php");
						$sql = "select * from sales_led where pay=0 and emp_name=(select name from employee_details where id=".$_SESSION['user_id'].")";
	...
	allowOutsideClick: false
		...
		window.location.href='payment.php?led='+result+'&ch='+text;
                    }, function (dismiss) {
                if (dismiss === 'cancel') {
		swal.closeModal();
                }
