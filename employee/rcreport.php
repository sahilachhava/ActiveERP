			...
			<div class="row">
                                <div class="col-12">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">Overall Profit :  <?php $sql2 = "select profit from rcombo where emp_name=(select name from employee_details where id=".$_SESSION["user_id"].")";
					...
					<th>Sales</th>
						...
						if(isset($_REQUEST['month']))
						{
							...
							if($_REQUEST["month"] != ""){
								if($query == ""){
									$query = "SELECT * FROM `rcombo` WHERE `ro_dt` BETWEEN '2018/$dd/01' AND '2018/$dd/31' and emp_name=(select name from employee_details where id=".$_SESSION["user_id"].")";
								}
							}
						...
						{
							include("../connection.php");
							$sql = "select * from rcombo where emp_name=(select name from employee_details where id=".$_SESSION["user_id"].")";
