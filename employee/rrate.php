                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title">Radio RO New Rate</h4>
                                    </div>
                                </div>
                            </div>
					...
					<form action="<?php $_PHP_SELF ?>" method="post">
						...
						while($row1=mysqli_fetch_array($result1))
						{
							...
							for($i=0; $i<$le; $i++)
							{
								...
								echo "<div class='col-sm-10'>";
								echo "<input class='form-control' type='text' value='$rt[$i]' placeholder='New/Old Rate per second' name='rate[]' id='example-time-input' required> 
								</div>
							    </div>";
							    echo "<div class='form-group row'>";
...
<?php
	if(isset($_POST['rate']))
	{
		...
		$sql = "update ro_radio set rate='$rate', dis = '$dis', amt = '$amt', cgst = '$cgst', sgst = '$sgst', gtotal = '$gtotal' where r_no=".$rs;
		$result = mysqli_query($conn,$sql);
		echo "<script type='text/javascript'>window.location.href='p_radio.php?disabled=1'</script>";
	}
