...
<head>
        ...
        <title>Combo Reports :: Active ERP</title>
                                    ...
                                    <div class="page-title-box">
                                        <div class="btn-group float-right">
                                            <ol class="breadcrumb hide-phone p-0 m-0">
                                                ...
                                                <li class="breadcrumb-item active">Combo Reports</li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">Combo Reports</h4>
                                    </div>
                                </div>
                            </div>
			...
			<div class="row">
                                <div class="col-12">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">Overall Profit : <?php $sql2 = "select profit from combo where emp_name=(select name from employee_details where id=".$_SESSION["user_id"].")";
					...
					<th>Payable GST</th>
						...
						if(isset($_REQUEST['month']))
						{
							...
							if($_REQUEST["month"] != ""){
								if($query == ""){
									$query = "SELECT * FROM `combo` WHERE `ro_dt` BETWEEN '2018/$dd/01' AND '2018/$dd/31' and emp_name=(select name from employee_details where id=".$_SESSION["user_id"].")";
								}
							}
						...
						{
							include("../connection.php");
							$sql = "select * from combo where emp_name=(select name from employee_details where id=".$_SESSION["user_id"].")";
