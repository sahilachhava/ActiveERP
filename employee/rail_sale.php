                                    ...
                                    <div class="page-title-box">
                                        <div class="btn-group float-right">
                                            <ol class="breadcrumb hide-phone p-0 m-0">
                                                ...
                                                <li class="breadcrumb-item active">Railway Sales</li>
                                            </ol>
                                        </div>
			    ...
			    <div class="row">
					...
					<form action="<?php $_PHP_SELF ?>" method="post">
                                            <div class="form-group row">
                                                <label for="example-password-input" class="col-sm-2 col-form-label">Railway RO No</label>
                                                <div class="col-sm-10">
                                                     <select class="form-control" name="ro[]" required>
                                                        <option value="">Select</option>
                                                        <?php
							 include("../connection.php");
							 $sup1 = "select rono,client from ro_rail where s=0 and emp_name=(select name from employee_details where id=".$_SESSION['user_id'].")";
...
<?php
	if(isset($_POST['save']))
	{
		...
		echo "<script type='text/javascript'>
			window.location.href = 'rail_sales.php?$ttt';
			</script>";
	}
?>