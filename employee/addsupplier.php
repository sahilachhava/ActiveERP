...
<head>
        ...
        <title>Add New Supplier :: Active ERP</title>
			    ...
			    <div class="row">
					...
					<form action="<?php $_PHP_SELF ?>" method="post">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" name="name" placeholder="Company/Supplier Name" value="" id="example-text-input" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
					...
					<div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" value="" placeholder="CDXXXXXX6A"  name="pan" id="example-time-input" required>
                                                </div>
                                            </div>
					<div class="form-group row">
                                                <label for="example-time-input" class="col-sm-2 col-form-label">GSTIN/UIN</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" value="" placeholder="24ACXXXXXXXXXZ1"  name="gst" id="example-time-input" required>
                                                </div>
                                            </div>
					<div class="form-group">
					 <label for="example-time-input" class="col-sm-2 col-form-label" ></label>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <button type="submit" class="btn btn-primary waves-effect waves-light">Add Supplier</button>
...
<?php
	if(isset($_POST['name']))
	{
		...
		$sql = "insert into supplier_details(name,street,area,city,state,pincode,email,phone,pan,gst,emp_name) values('$name','$street','$area','$city','$state','$pin','$mail','$phon','$pana','$gsta','$emp')";
