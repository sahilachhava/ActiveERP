						 ...
						 <?php
							...
							if(isset($_REQUEST['type']))
							{
								...
								if($s=="IRIS 360 LED Screen")
								{
									echo "<select class='form-control' name='ro' required>";
									echo "<option value=''>Select</option>";
									$sup1 = "select rono,client from sales_led where emp_name=(select name from employee_details where id=".$_SESSION["user_id"].")";
									$sup2 = mysqli_query($conn,$sup1);
									while($sup3=mysqli_fetch_array($sup2))
									{
										extract($sup3);
								...
								elseif($s=="Railway Expense")
								{
									echo "<select class='form-control' name='ro' required>";
									echo "<option value=''>Select</option>";
									$sup1 = "select rono,client from sales_rail where emp_name=(select name from employee_details where id=".$_SESSION["user_id"].")";
									$sup2 = mysqli_query($conn,$sup1);
									while($sup3=mysqli_fetch_array($sup2))
									{
										extract($sup3);
