...
<?php
	if(isset($_POST['save']))
	{
		...
		$result = mysqli_query($conn,$sql) or die(mysqli_error($conn));
			...
			$sql9 = "insert into income(dt,pur,amt,des,emp,sale_id,type,in_no) values('$dt','Tax Invoice No - T/0$inn','$pof','Client: $cus,  Release Order No: $ron, Campaign Name: $cn','$emp','$son','led','$inn')";
