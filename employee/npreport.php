...
<head>
        ...
        <title>Newspaper Purchase Reports :: Active ERP</title>
                                    ...
                                    <div class="page-title-box">
                                        <div class="btn-group float-right">
                                            <ol class="breadcrumb hide-phone p-0 m-0">
                                                ...
                                                <li class="breadcrumb-item active">Newspaper Purchase Reports</li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">Newspaper Purchase Reports</h4>
                                    </div>
                                </div>
                            </div>
                            <!-- end page title end breadcrumb -->
			    <!-- dashboard content write below-->
			    <form action="npreport.php" method="post">
			...
			<div class="row">
                                <div class="col-12">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">Newspaper Purchase Reports</h4> <br>
					...
					<th>Our Profit</th>
						...
						if(isset($_REQUEST['month']))
						{
							...
							$dd = $_REQUEST["month"];
							if($_REQUEST["month"] != ""){
								$query = "SELECT * FROM `purchase_newspaper` WHERE `dt` BETWEEN '2018/$dd/01' AND '2018/$dd/31' AND emp_name=(select name from employee_details where id=".$_SESSION['user_id'].")";
							}
